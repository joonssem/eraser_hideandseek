# 교실 대소동: 사라진 지우개 찾기 v2.2.1 - 서버 구축 및 배포 가이드
...
> ⚠️ 아래 규칙은 로그인 없이 모든 읽기·쓰기를 허용합니다. 학급 활동용 테스트 구성에서만 사용하고, 데이터베이스에 개인정보나 민감한 데이터를 저장하지 마세요. 공개·장기 운영 시에는 Firebase Authentication과 접근 규칙을 별도로 설계해야 합니다.
